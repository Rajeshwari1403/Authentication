...
const VerifyEmailPage = () => {
  ...
  return (
    <div className='max-w-md w-full bg-gray-800 bg-opacity-50 backdrop-filter backdrop-blur-xl rounded-2xl shadow-xl overflow-hidden'>
      ...
      >
         <h2 className='mt-4 text-2xl font-bold mb-6 text-center bg-gradient-to-r from-blue-400 to=blue-700 text-transparent bg-clip-text'>Verify Your Email</h2>
         ...
         <form onSubmit={handleSubmit} className='space-y-6'>
          ...
          {error && <p className='text-red-500 font-semibold ml-10'>{error}</p>}
          <motion.button
             whileHover={{ scale: 1.05 }}
             whileTap={{ scale: 0.95 }}
             type='submit'
             disabled={isLoading || code.some((digit) => !digit)}
             className='w-full bg-gradient-to-r from-blue-400 to-blue-800 text-white font-bold py-3 px-4 rounded-sm shadow-lg
                        hover:from-blue-500 hover:to-blue-900 focus:outline-none focus:ring-2
