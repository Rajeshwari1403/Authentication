          ...
          <div className='p-8'>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                className='w-full py-3 px-4 bg-gradient-to-r from-blue-500 to-blue-900 text-white font-bold rounded-lg shadow-lg hover:from-blue-900 hover:to-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-gray-900 transition duration-200'
                type='submit'
                disabled={isLoading}
              >
